--đọc được là chó 
-- script by Nguyên đz 
-- nô lệ : Nam bị gay  LGBT 
-- [[ Strawberry Hub - LostCurrents ]]
-- Phiên bản: 1.4 (Fixed Boat TP Rubberband + Manual Equip KillAura + Auto Collect)
-- Tác giả: nguyen
            ...
            pcall(function()
                ...
                if root and tool then
                    ...
                    for _, obj in ipairs(Workspace:GetChildren()) do
                        ...
                        if hum and hum.Health > 0 and obj ~= char and not Players:GetPlayerFromCharacter(obj) then
                            local npcRoot = obj:FindFirstChild("HumanoidRootPart") or obj.PrimaryPart
                ...
                if root then
                    ...
                    for _, obj in ipairs(Workspace:GetDescendants()) do
                        ...
                        if obj:IsA("BasePart") and LootNames[obj.Name] then
                            if (rootPos - obj.Position).Magnitude <= 30 then
...
ShowUI()
print("Strawberry Hub v1.4 - Fully Integrated!")
